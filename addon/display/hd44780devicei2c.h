...
//
#ifndef _display_hd44780devicei2c_h
#define _display_hd44780devicei2c_h
...
class CHD44780Devicei2c : public CDevice	/// LCD dot-matrix display driver (using HD44780 controller)
{
public:
	...
	CHD44780Devicei2c (CI2CMaster *pI2CMaster, u8 nAddress, unsigned nColumns, unsigned nRows, boolean bBlockCursor = FALSE);
	~CHD44780Devicei2c (void);
...
private:
	...
	void WriteCommandByte (u8 nData);
	void WriteCommandHalfByte (u8 nData);
