...
//
#ifndef _httpbootserver_h
#define _httpbootserver_h

#include <circle/net/httpdaemon.h>
#include <circle/types.h>

class CHTTPBootServer : public CHTTPDaemon
{
public:
	CHTTPBootServer (CNetSubSystem *pNetSubSystem,
			 u16		nPort,
			 unsigned	nMaxMultipartSize,
			 CSocket       *pSocket = 0);	// is 0 for 1st created instance (listener)
	~CHTTPBootServer (void);
