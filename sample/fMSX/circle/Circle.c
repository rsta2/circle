...
#define RGB16(r,g,b) ((r<<8)|(g<<3)|(b>>6))
#define X11GetColor(r,g,b) RGB16(r,g,b)
...
const char *Title     = "fMSX Circle 4.4";  /* Program version */
...
int InitMachine(void)
{
  ...
  for(J=0;J<256;J++)
    BPal[J]=RGB16(((J>>2)&0x07)*255/7,((J>>5)&0x07)*255/7,(J&0x03)*255/3);
