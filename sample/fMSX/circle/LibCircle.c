...
/**                        LibCircle.c                      **/
/**                                                         **/
/** This file contains Circle-dependent implementation      **/
...
/** InitCircle() ***********************************************/
/** Initialize Circle/X11 resources and set initial window    **/
/** title and dimensions.                                   **/
/*************************************************************/
int InitCircle(const char *Title,int Width,int Height)
{
...
/** TrashCircle() **********************************************/
/** Free resources allocated in InitCircle()                  **/
/*************************************************************/
void TrashCircle(void)
{
  /* Remove sync timer */
  SetSyncTimer(0);
  /* Shut down audio */
...
unsigned int X11GetColor(unsigned char R,unsigned char G,unsigned char B)
{
  ...
  if(!(Effects&EFF_VARBPP)) return(PIXEL(R,G,B));

  /* If variable BPP, compute pixel based on the screen depth */
  J=16;//DefaultDepthOfScreen(Scr);
  return(
